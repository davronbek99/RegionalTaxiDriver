...
import dev.davron.regionaltaxidriver.databinding.FragmentOnlineRegistrationBinding
...
class OnlineRegistrationFragment : Fragment() {
    ...
    private fun uiClickListener() {
        binding.onlineRegistrationButton.setOnClickListener {
            findNavController().navigate(R.id.to_registration_main)
        }
    }
}